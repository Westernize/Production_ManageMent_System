                ...
                <div className="customer-header">
                    <div className="header-left-section">
                        ...
                        <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flex: 1 }}>
                            {/* 검색바: 거래처관리 SearchBar 스타일로 통일 */}
                            <div className="search-bar-inline" style={{ flex: 1, maxWidth: '400px' }}>
                                <select
                                    className="search-select"
                                    value={searchType}
                                    onChange={(e) => { setSearchType(e.target.value); setSearchTerm(''); setAppliedSearchTerm(''); }}
                                >
                                ...
                                {searchType === 'typeNm' ? (
                                    <div style={{ display: 'flex', gap: '5px', flex: 1 }}>
                                        <input
                                            ...
                                            readOnly
                                            placeholder="분류를 선택하세요"
                                            onClick={() => setShowCategorySelectPopup(true)}
                                            style={{ cursor: 'pointer', backgroundColor: '#f9fafb' }}
                                        />
                                        <button
