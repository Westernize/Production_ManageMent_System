...
function 출고관리() {
  ...
  // 입고관리 기준에 맞게 폰트/패딩은 CSS(.excel-th/.excel-td)에 위임합니다.
  const listThStyle = {}
  const listTdStyle = {
    /* padding/fontSize는 CSS로 통일 (입고관리 기준) */
    lineHeight: 1.2,
      ...
      <div className="customer-management-wrapper">
        ...
        <div className="customer-header">
          <div className="header-left-section">
            <h2 className="page-title">출고관리 (주문)</h2>
                ...
                <tbody>
                  {currentItems.length === 0 ? (
                    ...
                    currentItems.map((row) => (
                      ...
                      >
                        <td className="excel-td excel-td-number" style={{ lineHeight: 1.2, verticalAlign: 'middle', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {row._no}
                        </td>
                        <td className="excel-td" style={{ lineHeight: 1.2, verticalAlign: 'middle', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {row.ORDER_CD}
                        </td>
                        <td className="excel-td" style={{ lineHeight: 1.2, verticalAlign: 'middle', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                          {row.ORDER_DT}
