...
function 입고관리() {
  ...
  // UI (compact) styles
  // =========================
  const compactThStyle = { padding: '5px 6px', fontSize: 11 }
  ...
  const compactCodeTdStyle = { ...compactTdStyle, fontSize: 10 }
  const compactNumTdStyle = { ...compactTdStyle, fontSize: 10 }
  const compactStatusTdStyle = { ...compactTdStyle, fontSize: 10 }
      ...
      <div className="customer-management-wrapper">
        ...
        <div className="customer-header">
          <div className="header-left-section">
            <h2 className="page-title">입고관리 (발주)</h2>
